...
const DetailRecipe = () => {
  return (
    <div className={detailstyle.customBody}>
      ...
      <footer class={`container-fluid mt-5 ${detailstyle.customFooter}`}>
        <div class="text-center m-5">
          <h4 class={detailstyle.h4}>Eat, Cook, Repeat</h4>
          <p class="text-muted">Share your best recipe by uploading here !</p>
        </div>
        <nav class="d-flex justify-content-center">
          <div class={`container ${detailstyle.customInnerFooter}`}>
            <div class={detailstyle.footerLinks}>
              <ul class="navbar-nav d-flex flex-row">
                <li class={detailstyle.customListFooter}>
                  <a href="">Product</a>
                </li>
                <li class={detailstyle.customListFooter}>
                  <a href="">Company</a>
            ...
            <div class={detailstyle.customArcademy}>
              <p>© Arcademy</p>
            </div>
          </div>
        </nav>
